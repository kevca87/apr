...
# ENFOQUE ITERATIVO
# def doit(x, y):
#     # Utilizar una cola para manejar las posiciones a procesar
#     queue = [(x, y)]
    
#     while queue:
#         x, y = queue.pop(0)  # Cambia a queue.pop() para DFS
#         ch = g[y][x] if (1 <= x <= X and 1 <= y <= Y) else '.'
...
#                 if g[y2][x2] == ' ':
#                     g[y2][x2] = ch
#                     queue.append((x2, y2))  # Agregar nuevas posiciones a la cola
